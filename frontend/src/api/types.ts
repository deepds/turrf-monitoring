...
export interface CycleProgress {
  ...
  /** Всего наблюдений в плане снимка. */
  planned: number;
  /** Получили ответ. */
  ...
  remaining: number;
  /**
   * Пробовали и не получили ответа. **Только это и есть пропуски.**
   *
   * Наблюдения, к которым сбор не подходил ни разу, сюда не входят: в начале
   * суток их столько же, сколько в плане, и показывать это число как пропуски
   * значит объявлять аварией нормальное начало работы.
   */
  holes: number;
  deadline: string;
  minutes_left: number;
